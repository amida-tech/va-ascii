...
IntObjToFhirStream.prototype._transform = function (va, encoding, cb) {
    ...
    var fhirKeys = Object.keys(fhirObject);
    async.eachSeries(fhirKeys, function (fhirRow, cb1) {
        async.series([function (cb2) {
            if (outputObj[fhirRow].self_demographics) {
                outputObj[fhirRow] = outputObj[fhirRow].self_demographics(outputObj[fhirRow], va.self_demographics);
                cb2();
            } else {
                cb2();
            }
        }, function (cb2) {
            if (outputObj[fhirRow].va_demographics) {
                outputObj[fhirRow] = outputObj[fhirRow].va_demographics(outputObj[fhirRow], va.va_demographics);
                cb2();
            } else {
                cb2();
            }
        }, function (cb2) {
            if (outputObj[fhirRow].va_appointments) {
                outputObj[fhirRow] = outputObj[fhirRow].va_appointments(outputObj[fhirRow], va.va_appointments);
                cb2();
            } else {
                cb2();
            }
        }, function (cb2) {
            if (outputObj[fhirRow].self_allergies) {
                outputObj[fhirRow] = outputObj[fhirRow].self_allergies(outputObj[fhirRow], va.self_allergies);
                cb2();
            } else {
                cb2();
            }
        }, function (cb2) {
            if (outputObj[fhirRow].va_allergies) {
                outputObj[fhirRow] = outputObj[fhirRow].va_allergies(outputObj[fhirRow], va.va_allergies);
                cb2();
            } else {
                cb2();
            }
        }, function (cb2) {
            if (outputObj[fhirRow].va_medications) {
                outputObj[fhirRow] = outputObj[fhirRow].va_medications(outputObj[fhirRow], va.va_medications);
                cb2();
            } else {
                cb2();
            }
        }, function (cb2) {
            if (outputObj[fhirRow].self_medications) {
                outputObj[fhirRow] = outputObj[fhirRow].self_medications(outputObj[fhirRow], va.self_medications);
                cb2();
            } else {
                cb2();
            }
        }, function (cb2) {
            if (outputObj[fhirRow].va_immunizations) {
                outputObj[fhirRow] = outputObj[fhirRow].va_immunizations(outputObj[fhirRow], va.va_immunizations);
                cb2();
            } else {
                cb2();
            }
        }, function (cb2) {
            if (outputObj[fhirRow].self_immunizations) {
                outputObj[fhirRow] = outputObj[fhirRow].self_immunizations(outputObj[fhirRow], va.self_immunizations);
                cb2();
            } else {
                cb2();
            }
        }, function (cb2) {
            if (outputObj[fhirRow].va_problems) {
                outputObj[fhirRow] = outputObj[fhirRow].va_problems(outputObj[fhirRow], va.va_problems);
                cb2();
            } else {
                cb2();
            }
        }, function (cb2) {
            if (outputObj[fhirRow].va_admission_discharge) {
                outputObj[fhirRow] = outputObj[fhirRow].va_admission_discharge(outputObj[fhirRow], va.va_admission_discharge);
                cb2();
            } else {
                cb2();
            }
        }, function (cb2) {
            if (outputObj[fhirRow].va_vitals) {
                outputObj[fhirRow] = outputObj[fhirRow].va_vitals(outputObj[fhirRow], va.va_vitals);
                cb2();
            } else {
                cb2();
            }
        }, function (cb2) {
            if (outputObj[fhirRow].self_vitals) {
                outputObj[fhirRow] = outputObj[fhirRow].self_vitals(outputObj[fhirRow], va.self_vitals);
                cb2();
            } else {
                cb2();
            }
