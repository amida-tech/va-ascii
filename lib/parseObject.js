            ...
            process: function (processed, match) {
                ...
                if (obj.allergies) {
                    if (obj.allergies[obj.allergies.length - 1].comments) {
                        var comment = obj.allergies[obj.allergies.length-1].comments;
                        comment += ' ' + match[1].trim();
                        obj.allergies[obj.allergies.length-1].comments = comment;
                    }
                }
                return obj;
            },
        ...
        process: function (processed, match) {
            ...
            if (obj.medications) {
                if (obj.medications[obj.medications.length - 1].instructions) {
                    var instruction = obj.medications[obj.medications.length-1].instructions;
                    instruction += ' ' + match[1].trim();
                    obj.medications[obj.medications.length-1].instructions = instruction;
                }
            }
            return obj;
        },
        ...
        process: function (processed, match) {
            ...
            if (obj.problems) {
                if (obj.problems[obj.problems.length - 1].comments) {
                    var comment = obj.problems[obj.problems.length-1].comments;
                    comment += ' ' + match[1].trim();
                    obj.problems[obj.problems.length-1].comments = comment;
                }
            }
            return obj;
        },
