    ...
    Proc: {
        Patient: {
            "self_demographics": function (proc, s_d) {
                ...
                //TODO: patient.text
                outObj.Patient.Patient = patient;
                ...
                if (v_d.facilities) {
                    for (var i = 0; i < v_d.facilities.length; i++) {
                        var org = {
                            ...
                            "name": "" //e.g. "Good Health Clinic"
                        };
                        org.name = _.get(v_d.facilities[i], 'va_treating_facility', '');
                        outObj.Organizations.push(org);
                        ...
                        outObj.Patient.Patient.name.push(name);
                        ...
                        outObj.Patient.Patient.address.push(address);

                        if (_.get(v_d.facilities[i], "permanentaddress.home_phone_number", "--") !== "--") {
                            outObj.Patient.Patient.telecom.push({
                                "system": "phone",
                        ...
                        outObj.Patient.Patient.contact.push(emer_contact);
                    }
                }
                return outObj;
            }
        ...
        Medication: {
            ...
            self_medications: function (proc, s_a) {
                ...
                for (var i = 0; i < s_a.medications.length; i++) {
                    ...
                    outObj.MedicationStatements.push(medicationstatement);
                }
            ...
            va_immunizations: function (proc, v_i) {
                ...
                for (var i = 0; i < v_i.immunizations.length; i++) {
                    ...
                    var immunization = {
                        ...
                        "lotNumber": "", //e.g. "AAJN11K",
                        "expirationDate": "" //e.g. "2015-02-15"
                    };
                    ...
                    outObj.Immunizations.push(immunization);
                }
                return outObj;
            },
        ...
        Condition: {
            va_problems: function (proc, v_p) {
                ...
                for (var i = 0; i < v_p.problems.length; i++) {
                    ...
                    outObj.Conditions.push(problem);
                }
                return outObj;
            }
        },
            ...
            va_vitals: function (proc, v_v) {
                ...
                for (var i = 0; i < v_v.vitals.length; i++) {
                    ...
                    var vital = {
                        ...
                        "issued": "", //e.g. "2013-04-04T13:27:00+01:00",
                        "status": "", //e.g. "entered in error",
                        "reliability": "", //e.g. "questionable",
                        "bodySite": {
                            "coding": [
                                {
                                    "system": "", //e.g. "http://snomed.info/sct",
                    ...
                    outObj.Observations.push(vital);
                }
                return outObj;
            },
