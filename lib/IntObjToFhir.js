    ...
    async.eachSeries(fhirKeys,function(fhirRow, cb1) {
        async.series([function (cb2) {
            if (outputObj[fhirRow].self_demographics) {
                outputObj[fhirRow] = outputObj[fhirRow].self_demographics(outputObj.Patient, va.self_demographics);
                cb2();
            } else {
                cb2();
            }
            ...
            if (outputObj[fhirRow].va_demographics) {
                outputObj[fhirRow] = outputObj[fhirRow].va_demographics(outputObj.Patient, va.va_demographics);
                cb2();
            } else {
                cb2();
            }
            ...
            if (outputObj[fhirRow].self_allergies) {
                outputObj[fhirRow] = outputObj[fhirRow].self_allergies(outputObj.AdverseReactionAllergies, va.self_allergies);
                cb2();
            } else {
                cb2();
            }
            ...
            if (outputObj[fhirRow].va_allergies) {
                outputObj[fhirRow] = outputObj[fhirRow].va_allergies(outputObj.AdverseReactionAllergies, va.va_allergies);
                cb2();
            } else {
                cb2();
            }
