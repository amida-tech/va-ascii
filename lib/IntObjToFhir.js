    ...
    async.eachSeries(fhirKeys,function(fhirRow, cb1) {
        async.series([function (cb2) {
            ...
            if (outputObj[fhirRow].self_allergies) {
                outputObj[fhirRow] = outputObj[fhirRow].self_allergies(outputObj.AllergyIntolerance, va.self_allergies);
                cb2();
            } else {
                cb2();
            }
            ...
            if (outputObj[fhirRow].va_allergies) {
                outputObj[fhirRow] = outputObj[fhirRow].va_allergies(outputObj.AllergyIntolerance, va.va_allergies);
                cb2();
            } else {
                cb2();
            }
