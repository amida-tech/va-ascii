...
module.exports = {
    patient: {
        ...
        "proc": function (processed, va) {
            ...
            if (_.get(va, "self_demographics.home_phone_number","") !== "") {
                outObj.patient.telecom.push({
                    "system": "phone",
                    "value": _.get(va, "self_demographics.home_phone_number",""),
                    "use": "home"
                });
            }

            if (_.get(va, "self_demographics.work_phone_number","") !== "") {
                outObj.patient.telecom.push({
                    "system": "phone",
                    "value": _.get(va, "self_demographics.work_phone_number",""),
                    "use": "work"
                });
            }

            if (_.get(va, "self_demographics.cell_phone_number","") !== "") {
                outObj.patient.telecom.push({
                    "system": "phone",
                    "value": _.get(va, "self_demographics.cell_phone_number",""),
                    "use": "cell"
                });
            }

            if (_.get(va, "self_demographics.fax_number","") !== "") {
                outObj.patient.telecom.push({
                    "system": "fax",
                    "value": _.get(va, "self_demographics.fax_number",""),
                    "use": "fax"
                });
            }

            if (_.get(va, "self_demographics.pager_number","") !== "") {
                outObj.patient.telecom.push({
                    "system": "pager",
                    "value": _.get(va, "self_demographics.pager_number",""),
                    "use": "pager"
                });
            }
            ...
            if (_.get(va, "self_demographics.email_address","") !== "") {
                outObj.patient.telecom.push({
                    "system": "email",
                    "value": _.get(va, "self_demographics.email_address",""),
                    "use": "email"
                });
            }
            ...
            var emergency_contacts = _.get(va,"self_demographics.emergencycontacts",[]);
