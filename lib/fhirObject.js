...
function Practitioner() {
    ...
    this.identifier = [
        {
            "use": "", //e.g. "official",
            "system": "", //e.g. "urn:oid:2.16.528.1.1007.3.1",
            "value": "" //e.g. "874635264"
        }
    ];
    this.name = {
    ...
    this.gender = {
        "coding": [
            {
                "system": "", //e.g. "http://hl7.org/fhir/v3/AdministrativeGender",
                "code": "", //e.g. "F",
                "display": "" //e.g. "Female"
            }
        ]
    };
    this.birthDate = ""; //e.g. "1971-11-07";
    this.organization = {
        "reference": "", //e.g. "Organization/f001",
        "display": "" //e.g. "BMC"
    };
    this.role = [
        {
            "coding": [
                {
                    "system": "", //e.g. "urn:oid:2.16.840.1.113883.2.4.15.111",
                    "code": "", //e.g. "01.000",
                    "display": "" //e.g. "Arts"
                }
            ],
            ...
            "coding": [
                {
                    "system": "", //e.g. "urn:oid:2.16.840.1.113883.2.4.15.111",
                    "code": "", //e.g. "01.015",
                    "display": "" //e.g. "Physician"
                }
            ],
            "text": "" //e.g. "specialisation"
        }
    ];
}
